...
class _PendingAdvanceBookingsContentWidgetState
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<PendingAdvanceBookingsBloc, PendingAdvanceBookingsState>(
      builder: (context, state) {
        ...
        final items = isSuccess ? state.allResults : <PendingAdvanceBookingItem>[];
        ...
        return RefreshIndicator(
          ...
          child: CustomScrollView(
            ...
            slivers: [
              ...
              // Header Widget
              SliverToBoxAdapter(
                child: PendingAdvanceBookingsHeaderWidget(count: totalCount),
              ),
